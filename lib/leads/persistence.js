...
import { buildDiscoveryRow, findCompanyForLead, fetchCompanyPeople, buildShortlistFromPeople, toContactCandidates, writeAiLeadsFile } from './company.js'
import { buildLinkedInPeopleSearchUrl, summarizeCandidatePool, buildPersonTitleStrategy, extractCandidatesFromArticles } from './analyzer.js'
...
export async function persistLinkedInCompanyMatchForLead({ userId, candidate, companyInfo }) {
